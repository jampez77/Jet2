...
There is an active [PR](https://github.com/hacs/default/pull/2058) to get this into [HACS](https://hacs.xyz/), once that is merged then you can install the **Jet2** integration by searching for it there in HA instance.
